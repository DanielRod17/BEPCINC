...
include('../../Resources/InfoFill/AccountFill.php');
...
?>
        <html>
            <head>
                ...
                <link rel="stylesheet" href="../Resources/CSS/Listas_Contenido/Pages/Account_Layout.css">
                <script src="../Resources/Javascript/AccountsJS.js"></script>
                <meta charset="UTF-8">
                <title>
                </title>
            </head>
                ...
                <div id="contenedor">
                    ...
                    <div id="contenido">
                        <div id="contenidoCTN">
                            ...
                            <!-- -->
                              <?php
                                  DisplayProjects($connection, $ID);
                              ?>
                            <!-- -->
                              <?php
                                  DisplaySponsors($connection, $ID);
                              ?>
                            <!-- -->
                              <?php
